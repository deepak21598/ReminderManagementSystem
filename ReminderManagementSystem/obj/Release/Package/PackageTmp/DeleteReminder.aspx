<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeleteReminder.aspx.cs" Inherits="ReminderManagementSystem.DeleteReminder" %>
...
<tr>
<th>Subject :</th>
<td><asp:DropDownList Id="ddlSubject" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlSubject_SelectedIndexChanged" Width="280px">
